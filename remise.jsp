...
<body id="page-top" data-bs-spy="scroll" data-bs-target="#mainNav" data-bs-offset="72" style="height: 0px;border-radius: 0px;box-shadow: 6px 4px rgb(217,217,217);">
    <%
        ...
        try{
            ...
            rem = trtmt.getPrixRemise(10,Double.valueOf(tot));
            remis = String.valueOf(rem);
        }catch(Exception e){}
    %>
    <%out.print(remis);%>
                    ...
                    <table class="table my-0" id="dataTable">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 399.7px;">Montant total avec remise (s'il y en a)</th>
                                <th style="width: 399.7px;">Faire une remise</th>
                                <th style="width: 399.7px;">Avec remise</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="width: 351.7px;"><a href="remise.jsp?idFacture=<%out.print(idFacture);%>&&idServ=<%out.print(detailFact[i][1]);%>&&tot=<%out.print(detailFact[i][7]);%>">Faire une remise</a></td>
                                <td style="width: 351.7px;"><%out.print(remis);%></td>
                        ...
                        <tfoot>
                            <tr>
                                <td><i class="fa fa-bold" aria-hidden="true">Total</i></td>
                                <td></td>
                                <td></td>
                                <td style="width: 351.7px;"><%out.print(montantTot[0][2]);%></td>
                        ...
                        <table class="table my-0" id="dataTable">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="width: 351.7px;"><%out.print(fact[0][3]);%></td>
